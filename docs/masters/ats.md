...
- **Platform and team leadership:** Lead a team of **15 engineers** and advise **2 engineering leaders** building Kafka-as-a-Service and Elasticsearch-as-a-Service platforms, achieving **five nines reliability** via Kubernetes Operators and robust infrastructure-as-code practices.
